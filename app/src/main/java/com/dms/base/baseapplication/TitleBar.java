...
/**
 * Created by 龚万全 on 2017/4/13.
 * Description:
 */

public class TitleBar extends ViewGroup implements View.OnClickListener{
    private final int DEFAULT_MAIN_TEXT_SIZE = 18;
    private final int DEFAULT_SUB_TEXT_SIZE = 12;
    private final int DEFAULT_ACTION_TEXT_SIZE = 15;
    private final int DEFAULT_TITLE_BAR_HEIGHT = 48;
    private final int DEFAULT_TITLE_BAR_BG_COLOR = Color.RED;
    private final int DEFAULT_TITLE_BAR_TEXT_COLOR = Color.WHITE;
    ...
    private void initView(Context context) {
        setBackgroundColor(DEFAULT_TITLE_BAR_BG_COLOR);
        ...
        mLeftText.setTextColor(DEFAULT_TITLE_BAR_TEXT_COLOR);
        ...
        mCenterText.setTextColor(DEFAULT_TITLE_BAR_TEXT_COLOR);
        mCenterText.setSingleLine();
        mCenterText.setGravity(Gravity.CENTER);
        mCenterText.setEllipsize(TextUtils.TruncateAt.END);

        mSubTitleText.setTextSize(DEFAULT_SUB_TEXT_SIZE);
        mSubTitleText.setTextColor(DEFAULT_TITLE_BAR_TEXT_COLOR);
    ...
    public void attachActivity(final AppCompatActivity activity) {
        setLeftImageResource(R.drawable.icon_title_bar_back);
        ...
        Toolbar parent = (Toolbar) this.getParent();
    ...
    private View inflateAction(Action action) {
        ...
        if (TextUtils.isEmpty(action.getText())) {
            ...
            text.setTextColor(DEFAULT_TITLE_BAR_TEXT_COLOR);
