...
public class CircleProgress extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        antiAlias = Constant.ANTI_ALIAS;

        mValue = Constant.DEFAULT_VALUE;
        mMaxValue = Constant.DEFAULT_MAX_VALUE;
        //内容数值精度格式
        mPrecision = 2;
        mPrecisionFormat = MiscUtil.getPrecisionFormat(mPrecision);
        mValueColor = Color.BLACK;
        mValueSize = MiscUtil.sp2px(Constant.DEFAULT_VALUE_SIZE);

        mArcWidth = MiscUtil.dipToPx(getContext(), Constant.DEFAULT_ARC_WIDTH);
        mStartAngle = Constant.DEFAULT_START_ANGLE;
        mSweepAngle = Constant.DEFAULT_SWEEP_ANGLE;

        mBgArcColor = Color.WHITE;
        mBgArcWidth = MiscUtil.dipToPx(getContext(), Constant.DEFAULT_ARC_WIDTH);
